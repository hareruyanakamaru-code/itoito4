      ...
      <div style="font-family:sans-serif;max-width:600px;margin:0 auto;padding:24px;background:#fffdf7;">
        ...
        <div style="background:#fff;border:1px solid #fde68a;border-radius:12px;padding:20px;margin:20px 0;">
          <table style="width:100%;border-collapse:collapse;font-size:14px;">
            ...
            <tr><td style="padding:8px 12px;font-weight:bold;">ホスト</td><td style="padding:8px 12px;color:#44403c;">${hostName}</td></tr>
          </table>
        </div>

        <div style="background:#f0fdf4;border:1px solid #bbf7d0;border-radius:12px;padding:16px;margin:16px 0;">
          <p style="color:#166534;font-size:14px;margin:0;line-height:1.7;">
            📩 ホストより <strong>3営業日以内</strong> にメールにてご連絡いたします。<br>
            しばらくお待ちください。
          </p>
        </div>
...
export async function sendHostApplicationNotification({
  ...
  await resend.emails.send({
    from: "itoito <onboarding@resend.dev>",
    to: notifyEmail,
    subject: `【itoito】ホスト申請が届きました：${applicantName}`,
    html: `
      <div style="font-family:sans-serif;max-width:600px;margin:0 auto;padding:24px;">
        <h2 style="color:#b45309;border-bottom:2px solid #fde68a;padding-bottom:8px;">ホスト申請が届きました</h2>
...
export async function sendHostApplicationConfirmation({
  ...
  await resend.emails.send({
    from: "itoito <onboarding@resend.dev>",
    to: applicantEmail,
    subject: "【itoito】ホスト申請を受け付けました",
    html: `
      <div style="font-family:sans-serif;max-width:600px;margin:0 auto;padding:24px;background:#fffdf7;">
        <div style="text-align:center;padding:24px 0 16px;">
          <span style="font-size:40px;">🌿</span>
          <h1 style="color:#b45309;font-size:20px;margin-top:12px;">ホスト申請を受け付けました</h1>
        </div>
        <p style="color:#57534e;font-size:14px;line-height:1.7;">${applicantName} 様<br><br>
          ホスト申請をいただきありがとうございます。<br>
...
export async function sendHostApprovalEmail({
  ...
  await resend.emails.send({
    from: "itoito <onboarding@resend.dev>",
    to: applicantEmail,
    subject: "【itoito】ホスト申請が承認されました 🎉",
    html: `
      <div style="font-family:sans-serif;max-width:600px;margin:0 auto;padding:24px;background:#fffdf7;">
        <div style="text-align:center;padding:24px 0 16px;">
          <span style="font-size:40px;">🎉</span>
          <h1 style="color:#b45309;font-size:20px;margin-top:12px;">ホスト申請が承認されました！</h1>
        </div>
        <p style="color:#57534e;font-size:14px;line-height:1.7;">${applicantName} 様<br><br>
          itoitoのホストとして承認されました。おめでとうございます！<br>
          さっそく体験を投稿して、ゲストとの出会いを楽しみましょう。
        </p>
